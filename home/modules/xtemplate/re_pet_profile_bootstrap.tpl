    ...
    <div class="col-xs-12" style="padding-left: 0px">
        ...
        <div class="col-xs-12 hidden-md hidden-lg" 
            ...
            <span style="font-family: RobotoSlabBold; 
                  font-size: 15px; 
                  vertical-align: middle;">THÚ CƯNG CỦA BẠN</span>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-8" 
            ...
            <div style="font-size: 17px;
                 margin-bottom: 20px">ĐĂNG KÝ THÚ CƯNG</div>
            <div style="color: red">{name}</div>
            <div class="col-xs-5 col-sm-3" style="padding: 0px; padding-bottom: 30px">
                <img src="{linkS}upload/avatar/{img_pet}" width="100%">
            </div>
                ...
                <div class="main_register">
                    <fieldset class="fieldset_reg_info">
                        <div class="col-xs-12 col-sm-6"
                             style="padding-left:0px">
                            <div>Tên gọi<span style="color:red">*</span></div>
                        ...
                        <div class="col-xs-12 col-sm-6"
                             style="padding-left:0px;"> 
                            <div>Ngày sinh <span style="color:red">*</span></div>
                            <div class="form-group">
                                <input type="text" 
                                       id="birthday" 
                                       name="birthday" 
                        ...
                        <div class="col-xs-12 col-sm-6"
                             style="padding-left:0px">
                            <div>Loài<span style="color:red">*</span></div>
                            <div class="form-group">
                                <input type="text" 
                                       id="species" 
                                       name="species"  
                        ...
                        <div class="col-xs-12 col-sm-6"
                             style="padding-left:0px">
                            <div>Chiều cao (cm)<span style="color:red">*</span></div>
                            <div class="form-group">
                                <input  type="text" 
                                        id="chieucao" 
                                        name="chieucao"  
                        ...
                        <div class="col-xs-12 col-sm-6"
                             style="padding-left:0px">
                            <div>Cân nặng (kg)<span style="color:red">*</span></div>
                            <div class="form-group">
                                <input  type="text"
                                        id="cannang"
                                        name="cannang"
                        ...
                        <div class="col-xs-12 col-sm-6"
                             style="padding-left:0px">
                            <div>Giới tính<span style="color:red">*</span></div>
                            <div class ="form-group">
                        ...
                        <div class="col-xs-12 col-sm-6"
                             style="padding-left:0px">
                            <div>Hình ảnh<span style="color:red">*</span></div>
                            <div class ="form-group">
                                <input  type="file" 
                                        id="petimage" 
                                        name="petimage" 
