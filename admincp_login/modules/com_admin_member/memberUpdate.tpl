...
<div class="user_left">
    <table style="text-align: left; float:left; margin-top:10px" border="0px;">
        <tr>
            <td align="center">
                <b style="font-family:Cambria; font-size:14px">Ảnh đại diện</b>
            </td>
        </tr>
        <tr>
            <td align="center">
                <img alt="" 
                     src="../../upload/avatar/{avatar}" 
                     width="120px" 
                     height="140px;">
            </td>
        </tr>
...
<div class="user_right" style = "float:left; margin-left:20px; width: 465px">
    <div class="newsPersonal updateUser" style="display: block;">
        <div class="top_newsPersonal" style="margin-top:10px">
            ...
            <div style="border: 1px solid #EAF3FE;">
                <div style="background-color: #EAF3FE; height: 30px; font-size: 14px; padding: 5px">
                ...
                <div class="listing_input" style="margin-bottom:10px">                    
                    <div class="post_label_container"  style="width: 160px">
                        <label class="postLabel"
                               style="width: 150px; margin-bottom:10px;">Tên hiển thị</label>
                    </div>
                    <div class="post_label_container" style= "width:auto">
                        <label class="postLabel" style= "width:auto">: {visible_name}</label>
                    </div>
                </div>
            </div>
        </div>   
        <div class="newsPersonal updateUser" 
             style="display:{none_block}; float:left">
            ...
            <div class="newsPersonal_inside">
                <div class="group_listing_input" id="group_listing_input">
                    ...
                    <div class="listing_input_new">
                        <div class="post_label_container">
                            <label class="postLabel" style="margin-bottom:10px; margin-top: 10px">Bản thân: </label>
                        </div>                                                                                
                        <textarea rows="3" 
                                  name="short_content" 
                                  maxlength="600"
                                  ...
                                  width: 451px;
                                  max-width: 457px;
                                  height: 100px">{short_content}</textarea>
                    </div>
                    <div class="listing_input_new">
                        <div class="post_label_container">
                            <label class="postLabel" style="margin-bottom:10px; margin-top: 10px">Địa chỉ:</label>
                        </div>                                                                                
                        <textarea rows="3" 
                                  name="address" 
                                  style ="text-align:left;width: 451px; max-width: 457px" disabled>{address}
                        </textarea>
                    </div>
                    <!--Them tinh thanh va quan huyen-->    	        
                    <table id = "info_Country_City_District" style="display:block; font-size: 12px">   		            
                        <tr>
                            <td id="info_Country">
                            ...
                            <td id = "info_District">
                                <p id="p_district" 
                                   style="margin-bottom:10px">Quận/Huyện <span style="color:red">*</span></p>
                    ...
                    <table id="table_Dia_Chi" style="font-size: 12px">	    	
                        <tr>
                            <td id = "info_ward">
                                <p id = "text_ward" style="margin-bottom:10px">Phường <span style="color:red">*</span></p>
                                <input type="text"
                                       id ="tags" 
                                       style="width:133px; margin-right:20px" 
                            ...
                            <td id = "info_street">                                                    
                                ...
                                <input type="text" 
                                       id ="tags_street" 
                                       style="margin-right:20px;width:133px"
                    ...
                    <table id="table_Chung_Cu" style="font-size: 12px">
                        <tr>
                            <td id = "info_adress_Chung_Cu">
                                <p id = "text_address_Chung_Cu"
                                   style="margin-bottom:10px">Chung cư / Tòa nhà </p>
                                <input type="text" 
                                       style="margin-right:20px;width:133px; margin-bottom:10px" 
            ...
            <div class="listing_input">
                ...
                <input id="email" 
                       ...
                       margin-left:0px; 
                       width:300px">&nbsp;<span style="color:red">*</span>
            </div>
            <div class="listing_input">
                <div class="post_label_container" style="clear:both">
                    <label class="postLabel" 
                           style="margin-bottom:10px">Facebook Link: </label>
                </div>
                <input id="facebook"
                       name="facebook"
                       type="text"
                       value="{facebook}"
                       maxlength="90"
                       style="margin-bottom:10px; margin-left:0px; width:300px">&nbsp;<span style="color:red">*</span>
            </div>
            <div class="listing_input">
                <div class="post_label_container" style="clear:both">
                    <label class="postLabel" 
                           style="margin-bottom:10px">Google+ Link: </label>
                </div>
                <input id="google" 
                       name="google" 
                       type="text"
            ...
            <div class="listing_input">
                <div class="post_label_container" style="clear:both">
                    <label class="postLabel"
                           style="margin-bottom:10px">Twitter Link: </label>
                </div>
                <input id="twitter"
                       name="twitter"
                       type="text"
            ...
            <div class="listing_input">
                <div class="post_label_container" style="clear:both">
                    <label class="postLabel"
                           style="margin-bottom:10px">Linkedin Link: </label>
                </div>
                <input id="linkedin"
                       name="linkedin"
                       type="text"
