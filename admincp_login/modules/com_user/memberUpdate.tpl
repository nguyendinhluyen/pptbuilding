    ...
    <form method='POST' id = "frm" name = "frm" enctype='multipart/form-data'>		
        <div class="newsPersonal_inside">
            <div class="group_listing_input" id="group_listing_input">								
                ...
                <div class="listing_input">
                    <div class="post_label_container" style="width: 260px;">                               
                        <label class="postLabel" 
                               style="width: 250px;margin-bottom:5px">Điểm thưởng 
                            <span style="margin-left:86px; font-weight:bold"> : </span>                                                                                                              	
                            <input  id= "awardscore" 
                                    name= "awardscore" 
                                    type="text" 
                                    value="{awardscore}"                                              
                                    ...
                                    color:#AA1F00; 
                                    font-size:14px; 
                                    font-family:Cambria; margin-left:2px; font-weight:bold"
                                    maxlength="4"/>
                        </label>  
                ...
                <div class="listing_input">                                   
                    ...
                    <div class="post_label_container" style= "width:auto">
                        <label class="postLabel" 
                               style= "width:auto; font-size:12px"><b style="color:#AA1F00; font-size:14px; font-family:Cambria">: {unusedscore}</b></label>
                    </div>                                        
                </div>
            </div>								
        </div>		
